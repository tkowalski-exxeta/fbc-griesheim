export default function Impressum() {
  return (
    <div className="container mx-auto">
      <h1 className="text-4xl font-bold py-4">Impressum</h1>

      <p className="py-4">Angaben gemäß § 5 TMG</p>

      <p className="py-4">
        1. Feldbogen-Sport-Club Griesheim e.V. <br />
        Wilhelm-Leuschner Straße 292
        <br />
        64347 Griesheim <br />
      </p>
      ...
      <p className="py-4">
        ...
        <br />
        Jens Hirschmüller <br />
        Karlstr. 30 <br />
        64283 Darmstadt <br />
      </p>

      <h2 className="font-bold pt-4">Haftungsausschluss:</h2>
      <p className="py-4">
        <h2 className="font-bold py-4">Haftung für Inhalte</h2>
        ...
        <h2 className="font-bold py-4">Haftung für Links</h2>
        <p>
        ...
        <h2 className="font-bold py-4">Urheberrecht</h2>
        <p>
        ...
        <h2 className="font-bold py-4">Datenschutz</h2>
        <p>
        ...
        <h2 className="font-bold py-4">Google Analytics</h2>
        <p>
